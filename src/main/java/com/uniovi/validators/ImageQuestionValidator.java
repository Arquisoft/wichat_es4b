...
@Component
public class ImageQuestionValidator implements Validator {
    @Override
    ...
    public void validate(Object target, Errors errors) {
        ImageQuestionDto question = (ImageQuestionDto) target;
        ...
        if (question.getImageUrl() == null || question.getImageUrl().isEmpty()) {
            errors.rejectValue("imageUrl", null,
                    "The imageUrl of the question cannot be empty");
        }
