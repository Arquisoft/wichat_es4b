    ...
    public String sendQuestionToLLM(String question, String ai,List<String> llmAnswers) {
        ...
        if(ai.equals("Empathy")){
            ...
            try {
                ...
                return extractResponse(response.getBody(), "Empathy");
            } catch (Exception e) {
                // Manejo de errores
...
// Primero agregamos todos los mensajes pasados del modelo
            ...
            try {
                ...
                // Extraer y procesar la respuesta
                return extractResponse(response.getBody(), "Gemini");
            } catch (Exception e) {
    ...
    private String extractResponse(Map<String, Object> response, String ai) {
        if(ai.equals("Empathy")){
            try {
