...
import com.uniovi.components.generators.QuestionBateriaGenerator;
...
import com.uniovi.services.impl.QuestionBateriaServiceImpl;
...
@Service
public class QuestionBateriaGeneratorService {
    private final QuestionService questionService;

    public static final String JSON_FILE_PATH = "static/JSON/QuestionBateriaTemplates.json";
    ...
    private final Logger log = LoggerFactory.getLogger(QuestionBateriaGeneratorService.class);

    private boolean started;

    @Autowired
    public QuestionBateriaGeneratorService(QuestionService questionService, Environment environment) throws IOException {
        this.questionService = questionService;
        this.environment = environment;
        ((QuestionBateriaServiceImpl)questionService).setQuestionBateriaGeneratorService(this);
        parseQuestionTypes();
    ...
    public void generateQuestions() throws IOException, InterruptedException {
        ...
        QuestionGenerator qgen = new QuestionBateriaGenerator(json);

        // Recorremos todos los tipos de preguntas
        for (QuestionType type : types) {
            List<QuestionDto> questions;

            // Generar preguntas para cada idioma
