...
public class QuestionImageGenerator extends QuestionGeneratorBaseImpl<QuestionImage> {
...
// Verificamos que haya resultados antes de procesarlos
        if (results != null && !results.isEmpty()) {
            ...
            for (String[] result : results) {
                ...
                List<Answer> options = this.generateOptionsL(results, correctAnswer, questionImageLabel);
    ...
    protected List<Answer> generateOptionsL(List<String[]> results, String correctAnswer, String answerLabel) {
