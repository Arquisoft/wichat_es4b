...
public abstract class QuestionGeneratorBaseImpl<T extends QuestionBase> implements QuestionGenerator<T> {
    ...
    public QuestionGeneratorBaseImpl(JsonNode jsonNode) {
