...
public class QuestionBateriaGenerator implements QuestionGenerator {
    ...
    private Logger logger = LoggerFactory.getLogger(QuestionBateriaGenerator.class);

    //CONSTRUCTOR
    public QuestionBateriaGenerator(JsonNode jsonNode) {
