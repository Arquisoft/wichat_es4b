...
public class HomeSteps extends Wichat_IntegrationTests {
    ...
    public void i_should_see_the_register_page() {
        SeleniumUtils.waitLoadElementsBy(driver, "h2", p.getString("signup.title", PropertiesExtractor.getSPANISH()), 10);
    }

    @Then("I should see the login page")
    public void iShouldSeeTheLoginPage() {
        SeleniumUtils.waitLoadElementsBy(driver, "h2", p.getString("login.title", PropertiesExtractor.getSPANISH()), 10);
    }
    ...
    public void iClickTheGlobalRankingButton() {
        List<WebElement> elems = SeleniumUtils.waitLoadElementsByXpath(driver, "//*[@id=\"navbarDropdown2\"]", 10);
        elems.get(0).click();
        elems = SeleniumUtils.waitLoadElementsByXpath(driver, "/html/body/nav/div/ul[1]/li[3]/ul/li[1]", 10);
        elems.get(0).click();
    }
    ...
    public void iClickTheGlobalImageRankingButton() {
        List<WebElement> elems = SeleniumUtils.waitLoadElementsByXpath(driver, "//*[@id=\"navbarDropdown2\"]", 10);
        elems.get(0).click();
        elems = SeleniumUtils.waitLoadElementsByXpath(driver, "/html/body/nav/div/ul[1]/li[3]/ul/li[3]/a", 10);
        elems.get(0).click();
    }

    @When("I click the instructions button")
    public void iClickTheInstructionsButton() {
        List<WebElement> elems = SeleniumUtils.waitLoadElementsByXpath(driver, "/html/body/nav/div/ul[1]/li[4]/a", 10);
        elems.get(0).click();
    }
    @Then("I should see the global ranking page")
    public void iShouldSeeTheGlobalRankingPage() {
        SeleniumUtils.waitLoadElementsBy(driver, "h2", p.getString("ranking.title", PropertiesExtractor.getSPANISH()), 10);
    }
    ...
    public void iShouldSeeTheInstructionsPage() {
        SeleniumUtils.waitLoadElementsBy(driver, "h2", p.getString("instructions.heading", PropertiesExtractor.getSPANISH()), 10);
    }

    @Then("I should not see the logout button")
    public void iShouldNotSeeTheLogoutButton() {
        SeleniumUtils.waitElementNotPresent(driver, "//*[@href=\"/Logout\"]", 10);
    }

    @Then("I should not see the profile button")
    public void iShouldNotSeeTheProfileButton() {
        SeleniumUtils.waitElementNotPresent(driver, "//*[@id=\"btnUser\"]", 10);
    }
    ...
    public void iShouldSeeThePage(int errorCode) {
        List<WebElement> elems = SeleniumUtils.waitLoadElementsBy(driver, "free", "/html/body/div[1]/div[1]/strong", 10);
    ...
    public void iClickTheAboutWIChatButton() {
        List<WebElement> elems = SeleniumUtils.waitLoadElementsByXpath(driver, "/html/body/nav/div/ul[1]/li[5]/a", 10);
        elems.get(0).click();
    }
    @Then("I should see the about WIChat page")
    public void iShouldSeeTheAboutWIChatPage() {
        SeleniumUtils.waitLoadElementsBy(driver, "h2","WIChat: Desarrollo y Objetivos", 10);
    }
}
