...
class GameSessionServiceImplTest {
    ...
    void startNewGame_ReturnsNewGameSession() {
        ...
        when(questionService.getRandomQuestions(GameSessionService.NORMAL_GAME_QUESTION_NUM)).thenReturn(questions);
        ...
        verify(questionService, times(1)).getRandomQuestions(GameSessionService.NORMAL_GAME_QUESTION_NUM);
    }
    ...
    void startNewMultiplayerGame_WithInvalidCode_ReturnsNull() {
        ...
        // Act
        GameSession session = gameSessionService.startNewMultiplayerGame(new Player(), 9999);
