...
The deployment url is: [https://arquisoft.github.io/wichat_es4b/](https://arquisoft.github.io/wichat_es4b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_es4b/](https://arquisoft.github.io/wichat_es4b/), we need to execute `npm run deploy`.
