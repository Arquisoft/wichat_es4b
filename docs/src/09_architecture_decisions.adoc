...
| https://github.com/Arquisoft/wichat_es4b/wiki/Registro-de-decisiones-arquitectonicas#adr-003-sistema-de-gesti%C3%B3n-de-base-de-datos-a-usar[ADR-003] | Data Base Management System to use | Medium
|===
