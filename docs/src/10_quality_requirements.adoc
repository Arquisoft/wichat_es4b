...
| link:#usage-scenarios-resilience[**Resilience**] | The system should recover from failures and continue operating in a degraded state when necessary.
...
| [[change-scenarios-scalability]] Scalability | User traffic significantly increases. | The system dynamically scales to maintain performance.
